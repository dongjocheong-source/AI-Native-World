...
const CATEGORIES = [
 ...
 
  {
    ...
    items: [
      { id: "recipe-1", title: "유용한 프롬프팅", meta: "20분", hue: 5,
        body: "유용한 skill들을 정리하고 있습니다." },
      { id: "recipe-2", title: "Skills & Plugin", meta: "15분", hue: 5,
        body: "마늘과 올리브오일만으로 만드는 심플한 파스타입니다." },
      { id: "recipe-3", title: "참고 디자인", meta: "5분", hue: 5,
        body: "집에서 에스프레소 머신 없이 만드는 라떼 레시피입니다." },
      { id: "recipe-4", title: "앱 만들기", meta: "30분", hue: 5,
        body: "좋은 앱 만들기 참조 sites들에 대한 정보 입니다." },
    ],
  },
